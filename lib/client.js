  ...
  function ContextMenu() {
    ...
    return React.createElement('div', { style: backdrop, onClick: close, onContextMenu: function (e) { e.preventDefault(); close() } },
      React.createElement('div', { style: menuStyle, onClick: function (e) { e.stopPropagation() } },
        ...
        s.ws.id ? React.createElement('div', { style: { height: '1px', background: 'rgba(128,128,128,.2)', margin: '4px 0' } }) : null,
        s.ws.id ? React.createElement('button', { style: Object.assign({}, ITEM, { color: '#ef5350' }), onClick: deleteWorkspace }, '🗑 删除工作区') : null,
      ),
    )
  }
